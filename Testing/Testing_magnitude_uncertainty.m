% This script is to test the performance of the proposed technique in the scenario of magnitude uncertainty
...
%                         DEC = -87;
        ...
        [star_matrix, I, x_cord, y_cord]= Plot_sky_images(Reci2body, FOV, img_height, img_width, pixel_size,cent_variance, no_ran_star, PSF_set,catalog);
